...
import { IPIpelineParms } from "../../../../../src";
import { deletePIpeline } from "../../../../../src/api/methods/delete/Delete";
...
describe("CICS define pipeline command", () => {

    beforeAll(async () => {
        TEST_ENVIRONMENT = await TestEnvironment.setUp({
            testName: "define_pipeline",
            installPlugin: true,
    ...
    it("should be able to display the help", () => {
        const output = runCliScript(__dirname + "/__scripts__/define_pipeline_help.sh", TEST_ENVIRONMENT, []);
    ...
    it("should get a syntax error if pipeline name is omitted", () => {
        const output = runCliScript(__dirname + "/__scripts__/define_pipeline.sh", TEST_ENVIRONMENT,
            ["", "FAKEGRP", "FAKECONG", "FAKESHEL", "FAKEWDIR", "FAKERGN"]);
    ...
    it("should get a syntax error if CSD group is omitted", () => {
        const output = runCliScript(__dirname + "/__scripts__/define_pipeline.sh", TEST_ENVIRONMENT,
            ["FAKESRV", "", "FAKECONG", "FAKESHEL", "FAKEWDIR", "FAKERGN"]);
        const stderr = output.stderr.toString();
        expect(stderr).toContain("Syntax");
    ...
    it("should get a syntax error if configfile path is omitted", () => {
        const output = runCliScript(__dirname + "/__scripts__/define_pipeline.sh", TEST_ENVIRONMENT,
            ["FAKESRV", "FAKEGRP", "", "FAKESHEL", "FAKEWDIR", "FAKERGN"]);
        const stderr = output.stderr.toString();
        expect(stderr).toContain("Syntax");
    ...
    it("should get a syntax error if shelf path is omitted", () => {
        const output = runCliScript(__dirname + "/__scripts__/define_pipeline.sh", TEST_ENVIRONMENT,
            ["FAKESRV", "FAKEGRP", "FAKECONG", "", "FAKEWDIR", "FAKERGN"]);
        const stderr = output.stderr.toString();
        expect(stderr).toContain("Syntax");
    ...
    it("should success if wsdir path is omitted", async () =>{
        const options: IPIpelineParms = { name: "FAKESRV", csdGroup: "FAKEGRP", regionName: "FAKERGN" };
        const output = runCliScript(__dirname + "/__scripts__/define_pipeline.sh", TEST_ENVIRONMENT,
            ["FAKESRV", "FAKEGRP", "FAKECONG", "FAKESHEL", "", "FAKERGN"]);
        const stderr = output.stderr.toString();
    ...
    it("should get a syntax error if region name is omitted", () => {
        const output = runCliScript(__dirname + "/__scripts__/define_pipeline.sh", TEST_ENVIRONMENT,
            ["FAKESRV", "FAKEGRP", "FAKECONG", "FAKESHEL", "FAKEWDIR", ""]);
        const stderr = output.stderr.toString();
        expect(stderr).toContain("Syntax");
